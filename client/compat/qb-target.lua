...
exportHandler('AddEntityZone', function(name, entities, settings, options)
    -- utils.warn('AddEntityZone is not supported by ox_target - try using addEntity/addLocalEntity.')
    api.addLocalEntity(entities, options.options)
    utils.warn(name)utils.warn(entities)utils.warn(settings)utils.warn(options)
end)
